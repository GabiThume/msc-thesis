...
O código desenvolvido durante esta pesquisa está disponibilizado em \url{https://github.com/GabiThume/msc-src} (geração artificial) e \url{http://dx.doi.org/10.5281/zenodo.15932} (quantização). Esses repositórios correspondem à última versão do código para possível reprodução da pesquisa.
