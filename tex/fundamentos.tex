...
\meutodo{mantenho a seção de deconvolução citada aqui?}
...
%--------------------------------------------------------------------------------
\meutodo{tinha deconvolução aqui, posso remover?}
...
%--------------------------------------------------------------------------------
\meutodo{tem uma aqui seção de médias não locais, é necessário?}
...
A tarefa de classificação de imagens consiste em tentar predizer a classe de uma determinada imagem. Na classificação supervisionada isso é realizado da seguinte forma: na etapa de treinamento o método recebe como entrada um conjunto de imagens para treino rotulado com suas respectivas classes; e etapa de classificação, quando são preditas as classes de um conjunto de imagens de teste. Já um classificador não-supervisionado não recebe como entrada as imagens de treino rotuladas. Dessa forma, deve determinar sozinho quais representam cada classe.
