...
\section{Método: Borramento}
\subsection{Parâmetros}
\subsection{Variações}
\subsection{Algorítimo}


\section{Método: Mistura ponderada}
\begin{figure}[hbpt]
\begin{center}
  \includegraphics[width=1\linewidth]{\detokenize {figuras/geracao/mistura.png}}
\end{center}
 \caption[]{\textit{Fonte: Elaborado pela autora.}}
\label{fig:mistura}
\end{figure}
...
\section{Método: Aguçamento}
\section{Método: Composição}

\section{Método: Mistura limiarizada}
\begin{figure}[hbpt]
\begin{center}
  \includegraphics[width=1\linewidth]{\detokenize {figuras/geracao/threshold.png}}
\end{center}
 \caption[]{\textit{Fonte: Elaborado pela autora.}}
\label{fig:threshold}
\end{figure}

\section{Método: Mistura saliente}
\begin{figure}[hbpt]
\begin{center}
  \includegraphics[width=1\linewidth]{\detokenize {figuras/geracao/saliencia.png}}
\end{center}
 \caption[]{\textit{Fonte: Elaborado pela autora.}}
\label{fig:saliencia}
\end{figure}

\section{Método: SMOTE visual}
\section{Método: Adição de ruído}
