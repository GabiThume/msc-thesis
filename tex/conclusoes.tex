...
% TODO: Sugerir em trabalhos futuros um \emph{SMOTE visual} não-aleatório: tomando-se imagens próximas, assim como é feito no SMOTE, dada uma medida de distância qualquer (k-means, euclidiana?)
