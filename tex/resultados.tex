...
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/1/original-mistura.png}}
\end{subfigure}
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/1/original2-mistura.png}}
\end{subfigure}
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/1/resultado-mistura.png}}
\end{subfigure}
 \end{center}
 \caption[]{ \textit{Fonte:~Elaborado pela autora.}}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/1/original-ruido.png}}
\end{subfigure}
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/1/resultado-ruido.png}}
\end{subfigure}
 \end{center}
 \caption[]{ \textit{Fonte:~Elaborado pela autora.}}
...
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/2/original-saliencia.png}}
\end{subfigure}
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/2/original2-saliencia.png}}
\end{subfigure}
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/2/resultado-saliencia.png}}
\end{subfigure}
 \end{center}
 \caption[]{ \textit{Fonte:~Elaborado pela autora.}}
...
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/2/original-mistura.png}}
\end{subfigure}
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/2/original2-mistura.png}}
\end{subfigure}
\begin{subfigure}{.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/2/resultado-mistura.png}}
\end{subfigure}
 \end{center}
 \caption[]{ \textit{Fonte:~Elaborado pela autora.}}
...
\begin{figure}[!htbp]
  \begin{center}
    \begin{subfigure}{.3\linewidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/3/original-mistura.png}}
    \end{subfigure}
    \begin{subfigure}{.3\linewidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/3/original2-mistura.png}}
    \end{subfigure}
    \begin{subfigure}{.3\linewidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{figuras/resultados/3/resultado-mistura.png}}
    \end{subfigure}
  \end{center}
  \caption{}
  \label{fig:exp1:base}
...
% \begin{table}[!htbp]
% \centering
% \caption{Base DTD com 3 classes bem distintas de texturas utilizando LBP e Luminância}
% % \label{my-label}
% \begin{tabular}{|l|c|c|}
% \hline
% \textbf{Luminância e LBP} & \textbf{Média} & \textbf{Desvio padrão} \\ \hline
% Todos                     & 65.74          & 4.70                   \\ \hline
% Aguçamento                & 66.28          & 4.10                   \\ \hline
% Borramento                & 64.37          & 4.89                   \\ \hline
% Composição 16             & 64.68          & 5.62                   \\ \hline
% Composição 4              & 64.28          & 4.98                   \\ \hline
% Limiares                  & 67.01          & 4.93                   \\ \hline
% Mistura                   & \textbf{67.51} & 5.19                   \\ \hline
% Ruído                     & 65.85          & 4.23                   \\ \hline
% SMOTE Visual              & 66.63          & 4.84                   \\ \hline
% Saliência                 & 65.91          & 5.67                   \\ \hline
% SMOTE                     & 67.07          & 4.89                   \\ \hline
% Desbalanceado             & 63.69          & 4.89                   \\ \hline
% \end{tabular}
% \end{table}
