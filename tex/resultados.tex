...
\section{Experimento: Classes Elefante e Cavalo da COREL-1000}

\subsection{Base de Imagens}

\subsection{Ferramentas/Técnicas}

\subsection{Protocolo}

\subsection{Resultados e Discussão}

\subsubsection{Espaço de características}
...
\begin{figure}[htbp]
  \begin{center}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{original.png}}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{desbalanceado.png}}
    \end{subfigure}
  \end{center}
...
\begin{figure}[htbp]
  \begin{center}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{smote-treino.png}}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{geracao-treino.png}}
    \end{subfigure}
  \end{center}
...
Após o treinamento realizado com as novas imagens e exemplos, o conjunto de teste foi dado ao classificação 1-NN e na Figura~\ref{compara_vis_teste} o resultado está ilustrado. O interior dos quadrados representa a classe real dos exemplos, e a borda representa a classe predita pelo classificador. Nota-se que a melhoria na classificação com a geração de imagens fica visível e corresponde ao aumento do \texit{f-score}.

\begin{figure}[htbp]
  \begin{center}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{smote-teste.png}}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{geracao-teste.png}}
    \end{subfigure}
  \end{center}
  \caption{Comparação da geração com SMOTE versus campo visual.}
...
\begin{figure}[htbp]
  \begin{center}
    \begin{subfigure}{.32\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{desbalanceado-treino.png}}
    \end{subfigure}
    \begin{subfigure}{.32\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{smote-treino.png}}
...
\begin{figure}[htbp]
  \begin{center}
    \begin{subfigure}{.32\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{desbalanceado-region.png}}
    \end{subfigure}
    \begin{subfigure}{.32\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{smote-region.png}}
    \end{subfigure}
    \begin{subfigure}{.32\textwidth}
      \centering
      \includegraphics[width=\linewidth]{\detokenize{geracao-region.png}}
    \end{subfigure}
  \end{center}
...
\begin{figure}[htbp]
  \begin{center}
      \includegraphics[scale=0.2]{\detokenize{vis-images.png}}
  \end{center}
