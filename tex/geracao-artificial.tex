...
\begin{figure}[!htbp]
  ...
  \end{center}
  \caption[Imagens representativas das classes \textit{Deer} e \textit{Ship}. São imagens em baixa resolução (32x32 pixels), o que dificulta o seu processamento e posterior classificação.]{Imagens representativas das classes \textit{Deer} e \textit{Ship}. São imagens em baixa resolução (32x32 pixels), o que dificulta o seu processamento e posterior classificação. \\ \textit{Fonte:~\citeonline{Krizhevsky2009}}.}
